...
public class PauseState extends State {
    ...
    public PauseState(Handler handler) {
        ...
        manager.addObject(new UiImageButton((float) (handler.getWidth() - Assets.resume[0].getWidth()) / 2, (float) (handler.getHeight() * 2 / 3 - Assets.resume[0].getHeight() / 2), Assets.resume[0].getWidth(), Assets.resume[0].getHeight(),
                Assets.resume, () -> {
            handler.getMouseManager().setUiManager(handler.getUiManager());
...
//        }));
        manager.addObject(new UiImageButton((float) (handler.getWidth() - Assets.quit[0].getWidth()) / 2, (float) (handler.getHeight() * 7 / 8 - Assets.quit[0].getHeight() / 2), Assets.quit[0].getWidth(), Assets.quit[0].getHeight(),
                Assets.quit, () -> {
